...
<body>
	...
	$(document).ready(function() {
		...
		<div id="paymentSection">
			<hr>
			<h2>Payment</h2>
			<label for="cardSelect">Card : </label> <select id="cardSelect"
				name="cardName">
			...
			</select> <br> <label for="cardNumberInput">Card No.: </label> <input
				type="text" id="cardNumberInput" placeholder="Enter card number">
		...
		$('#payButton').on('click', function() {
	        ...
	        const cardName = $('#cardSelect').val();
	        const cardNumber = $('#cardNumberInput').val();
	        const totalPrice = $('#responseMessage').text();
